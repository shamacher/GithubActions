[![Run App SamHamacher](https://github.com/shamacher/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/shamacher/GithubActions/actions/workflows/run-app.yaml)
